...
class TypeInferenceAndInheritance{
	...
	static MyClass getObje(int which){
		switch(which){
	...
	public static void main(String args[]){
		...
		// within the MyClass inheritance hierarchy, its declared
		// return type is MyClass. As a result, in all three cases
		//shown here, the type of the variables is inferred to be 
		//MyClass, even though different derived types of objects are obtained.
    ...
    //	mc3.y = 10; //Wrong! MyClass does nor have a y field.	
	}
}
